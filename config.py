...
TRAIN_CLASSIFY_LEARNING_RATE = 3e-5
USE_SIMPLIFIED_VGG = True
TRAIN_CLASSIFY_USE_BN = True
CLASSIFY_INPUT_WIDTH, CLASSIFY_INPUT_HEIGHT, CLASSIFY_INPUT_DEPTH, CLASSIFY_INPUT_CHANNEL = 40, 40, 40, 1
CLASSIFY_LOG_DIR = LOG_BASE_PATH + '/classify-run-{}'
CLASSIFY_POSITIVE_SAMPLE_RATIO = 0.5
TRAIN_CLASSIFY_SAMPLE_RANDOM_OFFSET = 10
...
TRAIN_CLASSIFY_STEPS_PER_EPOCH = 16
TRAIN_CLASSIFY_VALID_STEPS = 5
