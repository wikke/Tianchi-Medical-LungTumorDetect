...
# Debug
DEBUG_PLOT_WHEN_PREPROCESSING = True
...
TRAIN_CLASSIFY_POSITIVE_SAMPLE_RATIO = 0.25 if TRAIN_CLASSIFY_ENABLE_DATA_AUGUMENTATION else 0.5
...
DENSE_NET_ENABLE_DROPOUT = False
