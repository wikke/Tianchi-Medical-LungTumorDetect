...
# Inception V4
INCEPTION_V4_BLOCKS = 6
INCEPTION_V4_REDUCTION_STEPS = 2
INCEPTION_V4_KEEP_FILTERS = 128
INCEPTION_V4_ENABLE_DEPTHWISE_SEPARABLE_CONV_SHRINKAGE = 0.333
INCEPTION_V4_ENABLE_SPATIAL_SEPARABLE_CONV = True
INCEPTION_V4_DROPOUT = 0.5
